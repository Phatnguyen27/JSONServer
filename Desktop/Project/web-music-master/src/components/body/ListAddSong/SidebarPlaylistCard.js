            ...
            <Row className="sidebar-song">
                ...
                <Col xs="1" className="vote">
                    <div className="up-vote">
                        <MdThumbUp className="like" onClick = {this.upvoteClick}></MdThumbUp>   
                        <div className="text-center"><span className="num-vote">{upvote}</span> </div>
                    </div>
                    <div className="down-vote">
                        <MdThumbDown className="dislike" onClick = {this.downvoteClick}></MdThumbDown>
